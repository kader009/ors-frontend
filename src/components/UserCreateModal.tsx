      ...
      <div className="relative bg-[#f8fafc] dark:bg-gray-900 w-full max-w-md rounded-xl shadow-2xl overflow-hidden animate-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="pt-4 flex justify-end gap-2">
            ...
            <button
              disabled={isLoading}
              className="px-6 py-2 bg-primary hover:bg-primary-dark text-white rounded-lg text-xs font-bold flex items-center gap-2 transform active:scale-95 transition-all disabled:opacity-50 cursor-pointer border-none"
            >
